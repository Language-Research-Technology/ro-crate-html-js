...
class Preview {
    ...
    async display(id) {
        const datasetDisplay = this.renderMetadataForItem(id);
    ...
    summarizeDataset() {
        ...
        for (let i of keepIds) {
            allMeta += this.renderMetadataForItem(i, dontShowPreviews);
            allMeta += "<hr/><br/><br/>";
        }
        allMeta += `</div>`;
    ...
    renderMetadataForItem(id, dontShowPreviews) {
    ...
    templateParams(render_script) {
        ...
        return {
            html: this.summarizeDataset(),
            dataset_name: name,
            item_name: name,
            citation: this.text_citation,
            up_link: "",
            time_stamp: Date.now(),
            ROCrate_version: this.crate.defaults.ROCrate_version,
            spec_id: this.crate.defaults.ROCrate_Specification_Identifier,

...
const pkg = pack.default;
const version = pkg.version.slice(0, pkg.version.lastIndexOf('.'));
...
const defaults = {
  ...
  render_script: `https://unpkg.com/ro-crate-html@${version}/dist/ro-crate-dynamic.min.js`,
  multi_page_render_script: '',
